# ~/data/wym/workspace/mantaflow/build/manta /root/data/wym/workspace/my_pinerf/tools/eval/visual_eval1.py 
...
# _p = "/HPS/fluids-generation/"
# _pgt = _p +"work/code/nerf/Global-Flow-Transport/"
# ref_path = _pgt + "data/synthData/synthReal_000000/"
# glo_path = _pgt + "reconstruction/multiViewSynth/recon_seq_211203-152124_synth_f30-2_full-method/"
# out_path = _p +"nobackup/nerf/ex_TR20211210/logs/eval/scalarSyn_d2vfix_444_final/"
# hull_path = _p +"nobackup/nerf/ex_TR20210419/mydata/synth/hull/frame_%06d/volume_hull.npz"

# out_path = './log/eval_out/' + '8.10_v1_test_pinf'
# ref_path = 

# ref_path = '/mnt/data/wym/pinerf_original/gt/np'
ref_path = '/root/data/wym/workspace/mantadata_7.24/mantaScene2_3d/np'

# out_path = './log/eval_out/' + '8.18_test_ours_1/'
# our_path = '/mnt/data/wym/pinf_smoke/log/cyl/neus_cuda_8.4_v6_only_smoke_inside_sdf_loss_no_overlay_no_ghost_lossw_fix_bug/volumeout_400001'

# out_path = './log/eval_out/' + '8.18_test_ours_2/'
# our_path = '/mnt/data/wym/pinf_smoke/log/cyl/neus_baseline_5_add_boundary_loss/volumeout_600001'

out_path = './log/eval_out/' + '8.22_optical_flow/'
our_path = '/root/data/wym/workspace/my_pinerf/log/cyl/optical_flow/neus_cuda_8.20_7_all_train/volumeout_400001'

# glo_path = '/mnt/data/wym/pinerf_original/log/cyl_1/volumeout_200000'
glo_path = None
